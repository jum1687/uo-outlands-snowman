...
CODEXS = [
 ...
 },
 {
  ...
  "stances":[
    ...
    ("Maiming","致残","定身(Hinder)效果持续时长每级 +10%，过载定身(Overpowered Hinder)效果额外伤害 +10%/级"),
  ],
  "finishers":[
 ...
 },
 {
  ...
  "abilities":[
    ...
    ("Stun","眩晕","接下来 15 秒武器特攻还会对目标施加 (穿刺值/10) 秒的定身(Hinder)"),
 ...
 },
 {
  ...
  "stances":[
    ("Shield Bash","盾击","对战斗对象的伤害减免 +3%/级，被战斗对象近战命中时有 4%/级 几率对其施加 3 秒定身(Hinder)"),
